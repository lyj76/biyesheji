function [TimingEstimate FrequencyOffsetEstimate] = TEFEMMM(Signal,NumFFT,Threshold)
...
% Lambda2 =Lambda2(1:end/2);
% figure;plot(Lambda2);
% close; 
TimingEstimate = find(Lambda2 == max(Lambda2));
% disp(['TimingEstimate = ',num2str(TimingEstimate)])  
